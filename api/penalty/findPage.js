...
module.exports = async (req, res) => {
    ...
    let sql = 'select '
        + ' a.blockNumber, a.logIndex, a.blockHash hash, a.projectId, b.name project, a.itemID, a.requestKey,a.rewardAmount \'fine(USDT)\', a.sender reporterAddress, a.createTime time, c.decimals,c.simpleName tokenName, d.key_nonce nonce '
